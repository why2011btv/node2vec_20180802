...
def main(args):
    ...
    calculate_metrics(0, r_rank_list, r_rank_recipr_list, r_rank_list_filter, r_rank_recipr_list_filter)
    calculate_metrics(1, l_rank_list, l_rank_recipr_list, l_rank_list_filter, l_rank_recipr_list_filter)
